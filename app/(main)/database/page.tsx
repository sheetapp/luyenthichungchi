            ...
            <div className="max-w-[1600px] mx-auto py-8">
                ...
                <div className="mb-8 px-4">
                    <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
                        ...
                        <div className="flex items-center gap-5">
                            ...
                            <div>
                                <h1 className="text-3xl md:text-4xl font-black text-apple-text tracking-tight mb-1">Cơ sở dữ liệu</h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center gap-2 px-1">
                                ...
                                <label className="text-[11px] font-black text-apple-text-secondary uppercase tracking-[0.2em]">Hạng sát hạch</label>
                            </div>
                ...
                {loading ? (
                                    ...
                                    {isExpanded && (
                                        <div className="border-t border-apple-border/30 bg-apple-bg/30 animate-in slide-in-from-top-4 duration-500">
                                            <div className="p-6 md:p-8 space-y-6">
                                                <div className="flex items-center gap-3">
                                                    <h3 className="text-[11px] font-black text-apple-text-secondary uppercase tracking-[0.2em]">Các phương án trả lời</h3>
                    ...
                    <div className="text-center py-20 bg-apple-card rounded-[32px] border-2 border-dashed border-apple-border mx-4 shadow-inner">
                        ...
                        <p className="text-apple-text-secondary font-bold text-lg">Không tìm thấy câu hỏi nào</p>
                    </div>
                )}
                    ...
                    <div className="mt-12 flex flex-col md:flex-row items-center justify-between gap-6 px-4 pb-12">
                        <div className="flex items-center gap-3">
                            ...
                            <p className="text-[13px] text-apple-text-secondary font-bold">
                                Hiển thị <span className="text-apple-text">{(currentPage - 1) * itemsPerPage + 1} - {Math.min(currentPage * itemsPerPage, totalCount)}</span> trong tổng số <span className="text-apple-blue font-black">{totalCount}</span> câu hỏi
                            </p>
                        </div>
                        <div className="flex items-center gap-5">
                            <button
