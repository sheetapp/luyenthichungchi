                ...
                <div className="bg-white rounded-3xl p-10 shadow-xl border border-slate-100">
                    ...
                    <div className="mt-8 flex items-start gap-3 p-4 bg-slate-50 rounded-2xl border border-slate-100 select-none group cursor-pointer" onClick={() => setAgreed(!agreed)}>
                        ...
                        <p className="text-[11px] text-slate-500 leading-relaxed font-medium">
                            ...
                            <a href="../dieu-khoan-su-dung" className="text-blue-600 hover:underline font-bold" onClick={(e) => e.stopPropagation()}>
                                Điều khoản sử dụng
                            </a>
                            {' '}và{' '}
                            <a href="../chinh-sach-bao-mat" className="text-blue-600 hover:underline font-bold" onClick={(e) => e.stopPropagation()}>
                                Chính sách bảo mật
                            </a>
                        </p>
                    </div>
