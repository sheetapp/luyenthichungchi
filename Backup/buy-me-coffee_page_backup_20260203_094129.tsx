            ...
            <main className="hidden md:block max-w-6xl mx-auto px-6 pt-8">
                <div className="grid grid-cols-2 gap-8 items-start">
                    ...
                    <div className="space-y-6">
                        ...
                        {/* Account Card */}
                        <div className="bg-white dark:bg-slate-900 rounded-[28px] p-10 shadow-lg border border-slate-100 dark:border-slate-800 space-y-8">
                            {/* QR Section */}
                            ...
                            <div className="space-y-6">
                                {[
                                    ...
                                    },
                                    {
                                        ...
                                        desc: 'Dữ liệu thanh toán được xử lý trực tiếp qua ứng dụng ngân hàng của bạn, chúng mình chỉ ghi nhận lịch sử ủng hộ của bạn trên hệ thống và bạn hoàn toàn có thể kiểm tra trong Tài khoản/Lịch sử ủng hộ.'
                                    },
                                    {
